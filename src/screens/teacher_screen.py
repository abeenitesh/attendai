...
from src.db.db import check_teacher_exists, create_teacher, get_attendance_for_teacher, get_enrolled_students, get_teacher_subjects, teacher_login
...
def teacher_tab_attendance_records():
    ...
    for r in records:
        ...
        data.append({
            "ts_group": ts.isoformat().split(".")[0] if ts else None,
            "Time": ts.strftime("%Y-%m-%d %I:%M %p") if ts else "N/A",
